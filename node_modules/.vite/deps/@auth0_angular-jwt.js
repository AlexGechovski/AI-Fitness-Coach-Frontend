...
__export(core_exports, {
  ...
  ɵENABLED_SSR_FEATURES: () => ENABLED_SSR_FEATURES,
  ɵINJECTOR_SCOPE: () => INJECTOR_SCOPE,
  ɵIS_HYDRATION_DOM_REUSE_ENABLED: () => IS_HYDRATION_DOM_REUSE_ENABLED,
  ɵInitialRenderPendingTasks: () => InitialRenderPendingTasks,
  ɵLContext: () => LContext,
...
function computed(computation, options) {
  const node = new ComputedImpl(computation, (options == null ? void 0 : options.equal) ?? defaultEquals);
  return createSignalFromFunction(node, node.signal.bind(node));
}
var UNSET = Symbol("UNSET");
var COMPUTING = Symbol("COMPUTING");
var ERRORED = Symbol("ERRORED");
var ComputedImpl = class extends ReactiveNode {
...
var WritableSignalImpl = class extends ReactiveNode {
...
function signal(initialValue, options) {
  const signalNode = new WritableSignalImpl(initialValue, (options == null ? void 0 : options.equal) ?? defaultEquals);
...
function destroyLView(tView, lView) {
  ...
  if (!(lView[FLAGS] & 256)) {
    const renderer = lView[RENDERER];
    (_a = lView[REACTIVE_TEMPLATE_CONSUMER]) == null ? void 0 : _a.destroy();
...
function isDisconnectedNode$1(hydrationInfo, index) {
  ...
  return !!((_a = hydrationInfo.disconnectedNodes) == null ? void 0 : _a.has(index));
}
...
var VERSION = new Version("16.1.5");
...
function getOrCreateCurrentLViewConsumer() {
  currentConsumer ?? (currentConsumer = new ReactiveLViewConsumer());
  ...
  try {
    for (let i = 0; i < hostBindingOpCodes.length; i++) {
      ...
      if (opCode < 0) {
        ...
        consumer.runInContext(hostBindingFn, 2, context2);
      }
    }
  } finally {
...
function executeTemplate(tView, lView, templateFn, rf, context2) {
  ...
  try {
    ...
    if (isUpdatePhase) {
      consumer.runInContext(templateFn, rf, context2);
    } else {
      const prevConsumer = setActiveConsumer(null);
      try {
...
function effect(effectFn, options) {
  ...
  return effectManager.create(effectFn, destroyRef, !!(options == null ? void 0 : options.allowSignalWrites));
}
...
function detectChangesInternal(tView, lView, context2, notifyErrorHandler = true) {
  ...
  try {
    ...
    if (!checkNoChangesMode && rendererFactory.end)
      rendererFactory.end();
    !checkNoChangesMode && ((_a = lView[ENVIRONMENT].effectManager) == null ? void 0 : _a.flush());
  }
}
...
function refreshView(tView, lView, templateFn, context2) {
  ...
  !isInCheckNoChangesPass && ((_a = lView[ENVIRONMENT].effectManager) == null ? void 0 : _a.flush());
  enterView(lView);
  try {
    resetPreOrderHookFlags(lView);
...
var R3TemplateRef = class TemplateRef2 extends ViewEngineTemplateRef {
  ...
  createEmbeddedView(context2, injector) {
    return this.createEmbeddedViewImpl(context2, injector, null);
  }
  /**
   * @internal
   */
  createEmbeddedViewImpl(context2, injector, hydrationInfo) {
    ...
    const embeddedLView = createLView(this._declarationLView, embeddedTView, context2, viewFlags, null, embeddedTView.declTNode, null, null, null, injector || null, hydrationInfo || null);
  ...
  for (const viewRef of viewRefs) {
    ...
    if (lView !== null) {
      ...
      if (hostElement && !hostElement.hasAttribute(SKIP_HYDRATION_ATTR_NAME)) {
        ...
        annotateHostElementForHydration(hostElement, lView, context2);
    ...
    if (isLContainer(lView[i])) {
      ...
      if (tNode.type & 8) {
        ...
        if (tNode.type & 1) {
          ...
          } else if (((_a = rNode.nextSibling) == null ? void 0 : _a.nodeType) === Node.TEXT_NODE) {
            context2.corruptedTextNodes.set(
              rNode,
              "ngtns"
...
_PlatformLocation.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _PlatformLocation, deps: [], target: FactoryTarget.Injectable });
_PlatformLocation.ɵprov = ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _PlatformLocation, providedIn: "platform", useFactory: () => inject(BrowserPlatformLocation) });
var PlatformLocation = _PlatformLocation;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: PlatformLocation, decorators: [{
  type: Injectable,
...
_BrowserPlatformLocation.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _BrowserPlatformLocation, deps: [], target: FactoryTarget.Injectable });
_BrowserPlatformLocation.ɵprov = ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _BrowserPlatformLocation, providedIn: "platform", useFactory: () => new _BrowserPlatformLocation() });
var BrowserPlatformLocation = _BrowserPlatformLocation;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: BrowserPlatformLocation, decorators: [{
  type: Injectable,
  args: [{
    providedIn: "platform",
...
_LocationStrategy.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _LocationStrategy, deps: [], target: FactoryTarget.Injectable });
_LocationStrategy.ɵprov = ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _LocationStrategy, providedIn: "root", useFactory: () => inject(PathLocationStrategy) });
var LocationStrategy = _LocationStrategy;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: LocationStrategy, decorators: [{
  type: Injectable,
...
_PathLocationStrategy.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _PathLocationStrategy, deps: [{ token: PlatformLocation }, { token: APP_BASE_HREF, optional: true }], target: FactoryTarget.Injectable });
_PathLocationStrategy.ɵprov = ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _PathLocationStrategy, providedIn: "root" });
var PathLocationStrategy = _PathLocationStrategy;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: PathLocationStrategy, decorators: [{
  type: Injectable,
  args: [{ providedIn: "root" }]
}], ctorParameters: function() {
...
_HashLocationStrategy.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _HashLocationStrategy, deps: [{ token: PlatformLocation }, { token: APP_BASE_HREF, optional: true }], target: FactoryTarget.Injectable });
_HashLocationStrategy.ɵprov = ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _HashLocationStrategy });
var HashLocationStrategy = _HashLocationStrategy;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: HashLocationStrategy, decorators: [{
  type: Injectable
}], ctorParameters: function() {
  return [{ type: PlatformLocation }, { type: void 0, decorators: [{
    type: Optional
...
_Location.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _Location, deps: [{ token: LocationStrategy }], target: FactoryTarget.Injectable });
_Location.ɵprov = ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _Location, providedIn: "root", useFactory: createLocation });
var Location = _Location;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: Location, decorators: [{
  type: Injectable,
  args: [{
    providedIn: "root",
    // See #23917
...
_NgLocalization.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _NgLocalization, deps: [], target: FactoryTarget.Injectable });
_NgLocalization.ɵprov = ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _NgLocalization, providedIn: "root", useFactory: (locale) => new NgLocaleLocalization(locale), deps: [{ token: LOCALE_ID }] });
var NgLocalization = _NgLocalization;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: NgLocalization, decorators: [{
  type: Injectable,
  args: [{
    providedIn: "root",
...
_NgLocaleLocalization.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _NgLocaleLocalization, deps: [{ token: LOCALE_ID }], target: FactoryTarget.Injectable });
_NgLocaleLocalization.ɵprov = ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _NgLocaleLocalization });
var NgLocaleLocalization = _NgLocaleLocalization;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: NgLocaleLocalization, decorators: [{
  type: Injectable
}], ctorParameters: function() {
...
_NgClass.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _NgClass, deps: [{ token: IterableDiffers }, { token: KeyValueDiffers }, { token: ElementRef }, { token: Renderer2 }], target: FactoryTarget.Directive });
_NgClass.ɵdir = ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "16.1.5", type: _NgClass, isStandalone: true, selector: "[ngClass]", inputs: { klass: ["class", "klass"], ngClass: "ngClass" }, ngImport: core_exports });
var NgClass = _NgClass;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: NgClass, decorators: [{
  type: Directive,
  args: [{
    selector: "[ngClass]",
    standalone: true
...
_NgComponentOutlet.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _NgComponentOutlet, deps: [{ token: ViewContainerRef }], target: FactoryTarget.Directive });
_NgComponentOutlet.ɵdir = ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "16.1.5", type: _NgComponentOutlet, isStandalone: true, selector: "[ngComponentOutlet]", inputs: { ngComponentOutlet: "ngComponentOutlet", ngComponentOutletInjector: "ngComponentOutletInjector", ngComponentOutletContent: "ngComponentOutletContent", ngComponentOutletNgModule: "ngComponentOutletNgModule", ngComponentOutletNgModuleFactory: "ngComponentOutletNgModuleFactory" }, usesOnChanges: true, ngImport: core_exports });
var NgComponentOutlet = _NgComponentOutlet;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: NgComponentOutlet, decorators: [{
  type: Directive,
  args: [{
...
_NgForOf.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _NgForOf, deps: [{ token: ViewContainerRef }, { token: TemplateRef }, { token: IterableDiffers }], target: FactoryTarget.Directive });
_NgForOf.ɵdir = ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "16.1.5", type: _NgForOf, isStandalone: true, selector: "[ngFor][ngForOf]", inputs: { ngForOf: "ngForOf", ngForTrackBy: "ngForTrackBy", ngForTemplate: "ngForTemplate" }, ngImport: core_exports });
var NgForOf = _NgForOf;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: NgForOf, decorators: [{
  type: Directive,
  args: [{
...
_NgIf.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _NgIf, deps: [{ token: ViewContainerRef }, { token: TemplateRef }], target: FactoryTarget.Directive });
_NgIf.ɵdir = ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "16.1.5", type: _NgIf, isStandalone: true, selector: "[ngIf]", inputs: { ngIf: "ngIf", ngIfThen: "ngIfThen", ngIfElse: "ngIfElse" }, ngImport: core_exports });
var NgIf = _NgIf;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: NgIf, decorators: [{
  type: Directive,
  args: [{
    selector: "[ngIf]",
    standalone: true
...
_NgSwitch.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _NgSwitch, deps: [], target: FactoryTarget.Directive });
_NgSwitch.ɵdir = ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "16.1.5", type: _NgSwitch, isStandalone: true, selector: "[ngSwitch]", inputs: { ngSwitch: "ngSwitch" }, ngImport: core_exports });
var NgSwitch = _NgSwitch;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: NgSwitch, decorators: [{
  type: Directive,
  args: [{
    selector: "[ngSwitch]",
    standalone: true
...
_NgSwitchCase.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _NgSwitchCase, deps: [{ token: ViewContainerRef }, { token: TemplateRef }, { token: NgSwitch, host: true, optional: true }], target: FactoryTarget.Directive });
_NgSwitchCase.ɵdir = ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "16.1.5", type: _NgSwitchCase, isStandalone: true, selector: "[ngSwitchCase]", inputs: { ngSwitchCase: "ngSwitchCase" }, ngImport: core_exports });
var NgSwitchCase = _NgSwitchCase;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: NgSwitchCase, decorators: [{
  type: Directive,
  args: [{
...
_NgSwitchDefault.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _NgSwitchDefault, deps: [{ token: ViewContainerRef }, { token: TemplateRef }, { token: NgSwitch, host: true, optional: true }], target: FactoryTarget.Directive });
_NgSwitchDefault.ɵdir = ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "16.1.5", type: _NgSwitchDefault, isStandalone: true, selector: "[ngSwitchDefault]", ngImport: core_exports });
var NgSwitchDefault = _NgSwitchDefault;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: NgSwitchDefault, decorators: [{
  type: Directive,
  args: [{
...
_NgPlural.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _NgPlural, deps: [{ token: NgLocalization }], target: FactoryTarget.Directive });
_NgPlural.ɵdir = ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "16.1.5", type: _NgPlural, isStandalone: true, selector: "[ngPlural]", inputs: { ngPlural: "ngPlural" }, ngImport: core_exports });
var NgPlural = _NgPlural;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: NgPlural, decorators: [{
  type: Directive,
  args: [{
    selector: "[ngPlural]",
    standalone: true
...
_NgPluralCase.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _NgPluralCase, deps: [{ token: "ngPluralCase", attribute: true }, { token: TemplateRef }, { token: ViewContainerRef }, { token: NgPlural, host: true }], target: FactoryTarget.Directive });
_NgPluralCase.ɵdir = ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "16.1.5", type: _NgPluralCase, isStandalone: true, selector: "[ngPluralCase]", ngImport: core_exports });
var NgPluralCase = _NgPluralCase;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: NgPluralCase, decorators: [{
  type: Directive,
  args: [{
...
_NgStyle.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _NgStyle, deps: [{ token: ElementRef }, { token: KeyValueDiffers }, { token: Renderer2 }], target: FactoryTarget.Directive });
_NgStyle.ɵdir = ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "16.1.5", type: _NgStyle, isStandalone: true, selector: "[ngStyle]", inputs: { ngStyle: "ngStyle" }, ngImport: core_exports });
var NgStyle = _NgStyle;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: NgStyle, decorators: [{
  type: Directive,
  args: [{
    selector: "[ngStyle]",
    standalone: true
...
_NgTemplateOutlet.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _NgTemplateOutlet, deps: [{ token: ViewContainerRef }], target: FactoryTarget.Directive });
_NgTemplateOutlet.ɵdir = ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "16.1.5", type: _NgTemplateOutlet, isStandalone: true, selector: "[ngTemplateOutlet]", inputs: { ngTemplateOutletContext: "ngTemplateOutletContext", ngTemplateOutlet: "ngTemplateOutlet", ngTemplateOutletInjector: "ngTemplateOutletInjector" }, usesOnChanges: true, ngImport: core_exports });
var NgTemplateOutlet = _NgTemplateOutlet;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: NgTemplateOutlet, decorators: [{
  type: Directive,
  args: [{
...
_AsyncPipe.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _AsyncPipe, deps: [{ token: ChangeDetectorRef }], target: FactoryTarget.Pipe });
_AsyncPipe.ɵpipe = ɵɵngDeclarePipe({ minVersion: "14.0.0", version: "16.1.5", ngImport: core_exports, type: _AsyncPipe, isStandalone: true, name: "async", pure: false });
var AsyncPipe = _AsyncPipe;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: AsyncPipe, decorators: [{
  type: Pipe,
  args: [{
    name: "async",
    pure: false,
...
_LowerCasePipe.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _LowerCasePipe, deps: [], target: FactoryTarget.Pipe });
_LowerCasePipe.ɵpipe = ɵɵngDeclarePipe({ minVersion: "14.0.0", version: "16.1.5", ngImport: core_exports, type: _LowerCasePipe, isStandalone: true, name: "lowercase" });
var LowerCasePipe = _LowerCasePipe;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: LowerCasePipe, decorators: [{
  type: Pipe,
  args: [{
    name: "lowercase",
    standalone: true
...
_TitleCasePipe.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _TitleCasePipe, deps: [], target: FactoryTarget.Pipe });
_TitleCasePipe.ɵpipe = ɵɵngDeclarePipe({ minVersion: "14.0.0", version: "16.1.5", ngImport: core_exports, type: _TitleCasePipe, isStandalone: true, name: "titlecase" });
var TitleCasePipe = _TitleCasePipe;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: TitleCasePipe, decorators: [{
  type: Pipe,
  args: [{
    name: "titlecase",
    standalone: true
...
_UpperCasePipe.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _UpperCasePipe, deps: [], target: FactoryTarget.Pipe });
_UpperCasePipe.ɵpipe = ɵɵngDeclarePipe({ minVersion: "14.0.0", version: "16.1.5", ngImport: core_exports, type: _UpperCasePipe, isStandalone: true, name: "uppercase" });
var UpperCasePipe = _UpperCasePipe;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: UpperCasePipe, decorators: [{
  type: Pipe,
  args: [{
    name: "uppercase",
    standalone: true
...
_DatePipe.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _DatePipe, deps: [{ token: LOCALE_ID }, { token: DATE_PIPE_DEFAULT_TIMEZONE, optional: true }, { token: DATE_PIPE_DEFAULT_OPTIONS, optional: true }], target: FactoryTarget.Pipe });
_DatePipe.ɵpipe = ɵɵngDeclarePipe({ minVersion: "14.0.0", version: "16.1.5", ngImport: core_exports, type: _DatePipe, isStandalone: true, name: "date" });
var DatePipe = _DatePipe;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: DatePipe, decorators: [{
  type: Pipe,
  args: [{
    name: "date",
    pure: true,
...
_I18nPluralPipe.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _I18nPluralPipe, deps: [{ token: NgLocalization }], target: FactoryTarget.Pipe });
_I18nPluralPipe.ɵpipe = ɵɵngDeclarePipe({ minVersion: "14.0.0", version: "16.1.5", ngImport: core_exports, type: _I18nPluralPipe, isStandalone: true, name: "i18nPlural" });
var I18nPluralPipe = _I18nPluralPipe;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: I18nPluralPipe, decorators: [{
  type: Pipe,
  args: [{
    name: "i18nPlural",
    pure: true,
...
_I18nSelectPipe.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _I18nSelectPipe, deps: [], target: FactoryTarget.Pipe });
_I18nSelectPipe.ɵpipe = ɵɵngDeclarePipe({ minVersion: "14.0.0", version: "16.1.5", ngImport: core_exports, type: _I18nSelectPipe, isStandalone: true, name: "i18nSelect" });
var I18nSelectPipe = _I18nSelectPipe;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: I18nSelectPipe, decorators: [{
  type: Pipe,
  args: [{
    name: "i18nSelect",
    pure: true,
...
_JsonPipe.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _JsonPipe, deps: [], target: FactoryTarget.Pipe });
_JsonPipe.ɵpipe = ɵɵngDeclarePipe({ minVersion: "14.0.0", version: "16.1.5", ngImport: core_exports, type: _JsonPipe, isStandalone: true, name: "json", pure: false });
var JsonPipe = _JsonPipe;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: JsonPipe, decorators: [{
  type: Pipe,
  args: [{
    name: "json",
    pure: false,
...
_KeyValuePipe.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _KeyValuePipe, deps: [{ token: KeyValueDiffers }], target: FactoryTarget.Pipe });
_KeyValuePipe.ɵpipe = ɵɵngDeclarePipe({ minVersion: "14.0.0", version: "16.1.5", ngImport: core_exports, type: _KeyValuePipe, isStandalone: true, name: "keyvalue", pure: false });
var KeyValuePipe = _KeyValuePipe;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: KeyValuePipe, decorators: [{
  type: Pipe,
  args: [{
    name: "keyvalue",
    pure: false,
...
_DecimalPipe.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _DecimalPipe, deps: [{ token: LOCALE_ID }], target: FactoryTarget.Pipe });
_DecimalPipe.ɵpipe = ɵɵngDeclarePipe({ minVersion: "14.0.0", version: "16.1.5", ngImport: core_exports, type: _DecimalPipe, isStandalone: true, name: "number" });
var DecimalPipe = _DecimalPipe;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: DecimalPipe, decorators: [{
  type: Pipe,
  args: [{
    name: "number",
    standalone: true
...
_PercentPipe.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _PercentPipe, deps: [{ token: LOCALE_ID }], target: FactoryTarget.Pipe });
_PercentPipe.ɵpipe = ɵɵngDeclarePipe({ minVersion: "14.0.0", version: "16.1.5", ngImport: core_exports, type: _PercentPipe, isStandalone: true, name: "percent" });
var PercentPipe = _PercentPipe;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: PercentPipe, decorators: [{
  type: Pipe,
  args: [{
    name: "percent",
    standalone: true
...
_CurrencyPipe.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _CurrencyPipe, deps: [{ token: LOCALE_ID }, { token: DEFAULT_CURRENCY_CODE }], target: FactoryTarget.Pipe });
_CurrencyPipe.ɵpipe = ɵɵngDeclarePipe({ minVersion: "14.0.0", version: "16.1.5", ngImport: core_exports, type: _CurrencyPipe, isStandalone: true, name: "currency" });
var CurrencyPipe = _CurrencyPipe;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: CurrencyPipe, decorators: [{
  type: Pipe,
  args: [{
    name: "currency",
    standalone: true
...
_SlicePipe.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _SlicePipe, deps: [], target: FactoryTarget.Pipe });
_SlicePipe.ɵpipe = ɵɵngDeclarePipe({ minVersion: "14.0.0", version: "16.1.5", ngImport: core_exports, type: _SlicePipe, isStandalone: true, name: "slice", pure: false });
var SlicePipe = _SlicePipe;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: SlicePipe, decorators: [{
  type: Pipe,
  args: [{
    name: "slice",
    pure: false,
...
_CommonModule.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _CommonModule, deps: [], target: FactoryTarget.NgModule });
_CommonModule.ɵmod = ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "16.1.5", ngImport: core_exports, type: _CommonModule, imports: [NgClass, NgComponentOutlet, NgForOf, NgIf, NgTemplateOutlet, NgStyle, NgSwitch, NgSwitchCase, NgSwitchDefault, NgPlural, NgPluralCase, AsyncPipe, UpperCasePipe, LowerCasePipe, JsonPipe, SlicePipe, DecimalPipe, PercentPipe, TitleCasePipe, CurrencyPipe, DatePipe, I18nPluralPipe, I18nSelectPipe, KeyValuePipe], exports: [NgClass, NgComponentOutlet, NgForOf, NgIf, NgTemplateOutlet, NgStyle, NgSwitch, NgSwitchCase, NgSwitchDefault, NgPlural, NgPluralCase, AsyncPipe, UpperCasePipe, LowerCasePipe, JsonPipe, SlicePipe, DecimalPipe, PercentPipe, TitleCasePipe, CurrencyPipe, DatePipe, I18nPluralPipe, I18nSelectPipe, KeyValuePipe] });
_CommonModule.ɵinj = ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _CommonModule });
var CommonModule = _CommonModule;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: CommonModule, decorators: [{
  type: NgModule,
  args: [{
...
_LCPImageObserver.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _LCPImageObserver, deps: [], target: FactoryTarget.Injectable });
_LCPImageObserver.ɵprov = ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _LCPImageObserver, providedIn: "root" });
var LCPImageObserver = _LCPImageObserver;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: LCPImageObserver, decorators: [{
  type: Injectable,
  args: [{ providedIn: "root" }]
}], ctorParameters: function() {
  return [];
...
_PreconnectLinkChecker.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _PreconnectLinkChecker, deps: [], target: FactoryTarget.Injectable });
_PreconnectLinkChecker.ɵprov = ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _PreconnectLinkChecker, providedIn: "root" });
var PreconnectLinkChecker = _PreconnectLinkChecker;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: PreconnectLinkChecker, decorators: [{
  type: Injectable,
  args: [{ providedIn: "root" }]
}], ctorParameters: function() {
  return [];
...
_PreloadLinkCreator.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _PreloadLinkCreator, deps: [], target: FactoryTarget.Injectable });
_PreloadLinkCreator.ɵprov = ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _PreloadLinkCreator, providedIn: "root" });
var PreloadLinkCreator = _PreloadLinkCreator;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: PreloadLinkCreator, decorators: [{
  type: Injectable,
  args: [{ providedIn: "root" }]
}] });
...
_NgOptimizedImage.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _NgOptimizedImage, deps: [], target: FactoryTarget.Directive });
_NgOptimizedImage.ɵdir = ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "16.1.5", type: _NgOptimizedImage, isStandalone: true, selector: "img[ngSrc]", inputs: { ngSrc: "ngSrc", ngSrcset: "ngSrcset", sizes: "sizes", width: ["width", "width", numberAttribute], height: ["height", "height", numberAttribute], loading: "loading", priority: ["priority", "priority", booleanAttribute], loaderParams: "loaderParams", disableOptimizedSrcset: ["disableOptimizedSrcset", "disableOptimizedSrcset", booleanAttribute], fill: ["fill", "fill", booleanAttribute], src: "src", srcset: "srcset" }, host: { properties: { "style.position": 'fill ? "absolute" : null', "style.width": 'fill ? "100%" : null', "style.height": 'fill ? "100%" : null', "style.inset": 'fill ? "0px" : null' } }, usesOnChanges: true, ngImport: core_exports });
var NgOptimizedImage = _NgOptimizedImage;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: NgOptimizedImage, decorators: [{
  type: Directive,
  args: [{
    standalone: true,
    selector: "img[ngSrc]",
...
_HttpClient.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _HttpClient, deps: [{ token: HttpHandler }], target: FactoryTarget.Injectable });
_HttpClient.ɵprov = ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _HttpClient });
var HttpClient = _HttpClient;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: HttpClient, decorators: [{
  type: Injectable
}], ctorParameters: function() {
...
var _FetchBackend = class _FetchBackend {
  constructor() {
    var _a;
    this.fetchImpl = ((_a = inject(FetchFactory, { optional: true })) == null ? void 0 : _a.fetch) ?? fetch.bind(globalThis);
  }
  handle(request) {
    return new Observable((observer) => {
      const aborter = new AbortController();
      this.doRequest(request, aborter.signal, observer).then(noop3, (error) => observer.error(new HttpErrorResponse({ error })));
  ...
  async doRequest(request, signal2, observer) {
    ...
    let response;
    try {
      const fetchPromise = this.fetchImpl(request.urlWithParams, { signal: signal2, ...init });
    ...
    if (response.body) {
      ...
      while (true) {
        ...
        if (request.reportProgress) {
          partialText = request.responseType === "text" ? (partialText ?? "") + (decoder ?? (decoder = new TextDecoder())).decode(value, { stream: true }) : void 0;
          observer.next({
...
_FetchBackend.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _FetchBackend, deps: [], target: FactoryTarget.Injectable });
_FetchBackend.ɵprov = ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _FetchBackend });
var FetchBackend = _FetchBackend;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: FetchBackend, decorators: [{
  type: Injectable
}] });
...
_HttpInterceptorHandler.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _HttpInterceptorHandler, deps: [{ token: HttpBackend }, { token: EnvironmentInjector }], target: FactoryTarget.Injectable });
_HttpInterceptorHandler.ɵprov = ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _HttpInterceptorHandler });
var HttpInterceptorHandler = _HttpInterceptorHandler;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: HttpInterceptorHandler, decorators: [{
  type: Injectable
}], ctorParameters: function() {
  return [{ type: HttpBackend }, { type: EnvironmentInjector }];
} });
var nextRequestId = 0;
var foreignDocument;
...
_JsonpClientBackend.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _JsonpClientBackend, deps: [{ token: JsonpCallbackContext }, { token: DOCUMENT2 }], target: FactoryTarget.Injectable });
_JsonpClientBackend.ɵprov = ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _JsonpClientBackend });
var JsonpClientBackend = _JsonpClientBackend;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: JsonpClientBackend, decorators: [{
  type: Injectable
}], ctorParameters: function() {
...
_JsonpInterceptor.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _JsonpInterceptor, deps: [{ token: EnvironmentInjector }], target: FactoryTarget.Injectable });
_JsonpInterceptor.ɵprov = ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _JsonpInterceptor });
var JsonpInterceptor = _JsonpInterceptor;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: JsonpInterceptor, decorators: [{
  type: Injectable
}], ctorParameters: function() {
  return [{ type: EnvironmentInjector }];
} });
var XSSI_PREFIX = /^\)\]\}',?\n/;
...
_HttpXhrBackend.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _HttpXhrBackend, deps: [{ token: XhrFactory }], target: FactoryTarget.Injectable });
_HttpXhrBackend.ɵprov = ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _HttpXhrBackend });
var HttpXhrBackend = _HttpXhrBackend;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: HttpXhrBackend, decorators: [{
  type: Injectable
}], ctorParameters: function() {
...
_HttpXsrfCookieExtractor.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _HttpXsrfCookieExtractor, deps: [{ token: DOCUMENT2 }, { token: PLATFORM_ID }, { token: XSRF_COOKIE_NAME }], target: FactoryTarget.Injectable });
_HttpXsrfCookieExtractor.ɵprov = ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _HttpXsrfCookieExtractor });
var HttpXsrfCookieExtractor = _HttpXsrfCookieExtractor;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: HttpXsrfCookieExtractor, decorators: [{
  type: Injectable
}], ctorParameters: function() {
  return [{ type: void 0, decorators: [{
    type: Inject,
...
_HttpXsrfInterceptor.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _HttpXsrfInterceptor, deps: [{ token: EnvironmentInjector }], target: FactoryTarget.Injectable });
_HttpXsrfInterceptor.ɵprov = ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _HttpXsrfInterceptor });
var HttpXsrfInterceptor = _HttpXsrfInterceptor;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: HttpXsrfInterceptor, decorators: [{
  type: Injectable
}], ctorParameters: function() {
  return [{ type: EnvironmentInjector }];
} });
...
_HttpClientXsrfModule.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _HttpClientXsrfModule, deps: [], target: FactoryTarget.NgModule });
_HttpClientXsrfModule.ɵmod = ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "16.1.5", ngImport: core_exports, type: _HttpClientXsrfModule });
_HttpClientXsrfModule.ɵinj = ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _HttpClientXsrfModule, providers: [
  HttpXsrfInterceptor,
...
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: HttpClientXsrfModule, decorators: [{
  type: NgModule,
  args: [{
    providers: [
      HttpXsrfInterceptor,
...
_HttpClientModule.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _HttpClientModule, deps: [], target: FactoryTarget.NgModule });
_HttpClientModule.ɵmod = ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "16.1.5", ngImport: core_exports, type: _HttpClientModule });
_HttpClientModule.ɵinj = ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _HttpClientModule, providers: [
  provideHttpClient(withInterceptorsFromDi())
] });
var HttpClientModule = _HttpClientModule;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: HttpClientModule, decorators: [{
  type: NgModule,
  args: [{
    /**
...
_HttpClientJsonpModule.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _HttpClientJsonpModule, deps: [], target: FactoryTarget.NgModule });
_HttpClientJsonpModule.ɵmod = ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "16.1.5", ngImport: core_exports, type: _HttpClientJsonpModule });
_HttpClientJsonpModule.ɵinj = ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: _HttpClientJsonpModule, providers: [
  withJsonpSupport().ɵproviders
] });
var HttpClientJsonpModule = _HttpClientJsonpModule;
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.5", ngImport: core_exports, type: HttpClientJsonpModule, decorators: [{
  type: NgModule,
  args: [{
    providers: [
      withJsonpSupport().ɵproviders
...
var JwtHelperService = class {
  ...
  b64decode(str) {
    ...
    for (
      let bc = 0, bs, buffer2, idx = 0;
      // get next character
      buffer2 = str.charAt(idx++);
      // character found in table? initialize bit storage and add its ascii value;
      ~buffer2 && (bs = bc % 4 ? bs * 64 + buffer2 : buffer2, // and if not first of each 4 characters,
      // convert the first 8 bits to one ascii character
      bc++ % 4) ? output += String.fromCharCode(255 & bs >> (-2 * bc & 6)) : 0
    ) {
      buffer2 = chars.indexOf(buffer2);
    }
    return output;
  }
...
JwtHelperService.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.16", ngImport: core_exports, type: JwtHelperService, deps: [{ token: JWT_OPTIONS }], target: FactoryTarget.Injectable });
JwtHelperService.ɵprov = ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.16", ngImport: core_exports, type: JwtHelperService });
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.16", ngImport: core_exports, type: JwtHelperService, decorators: [{
  type: Injectable
}], ctorParameters: function() {
  return [{ type: void 0, decorators: [{
    type: Inject,
...
JwtInterceptor.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.16", ngImport: core_exports, type: JwtInterceptor, deps: [{ token: JWT_OPTIONS }, { token: JwtHelperService }, { token: DOCUMENT2 }], target: FactoryTarget.Injectable });
JwtInterceptor.ɵprov = ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.16", ngImport: core_exports, type: JwtInterceptor });
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.16", ngImport: core_exports, type: JwtInterceptor, decorators: [{
  type: Injectable
}], ctorParameters: function() {
  return [{ type: void 0, decorators: [{
    type: Inject,
...
JwtModule.ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.16", ngImport: core_exports, type: JwtModule, deps: [{ token: JwtModule, optional: true, skipSelf: true }], target: FactoryTarget.NgModule });
JwtModule.ɵmod = ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.16", ngImport: core_exports, type: JwtModule });
JwtModule.ɵinj = ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.2.16", ngImport: core_exports, type: JwtModule });
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.16", ngImport: core_exports, type: JwtModule, decorators: [{
  type: NgModule
}], ctorParameters: function() {
