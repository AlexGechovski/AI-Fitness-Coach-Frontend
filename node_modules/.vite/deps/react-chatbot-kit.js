...
var require_build = __commonJS({
  "node_modules/react-chatbot-kit/build/index.js"(exports, module) {
    (() => {
      ...
      const y = function(e2) {
        var t2 = e2.message, n2 = e2.withAvatar, s2 = void 0 === n2 || n2, c2 = e2.loading, i2 = e2.messages, l2 = e2.customComponents, u2 = e2.setState, d2 = e2.customStyles, g2 = e2.delay, f2 = e2.id, y2 = (0, r.useState)(false), b2 = y2[0], w2 = y2[1];
        (0, r.useEffect)(function() {
          var e3;
          return function(t3, r2) {
            var a2 = 750;
            g2 && (a2 += g2), e3 = setTimeout(function() {
      ...
      const S = function(e2) {
        var t2 = e2.state, n2 = e2.setState, s2 = e2.widgetRegistry, i2 = e2.messageParser, l2 = e2.parse, u2 = e2.customComponents, m2 = e2.actionProvider, d2 = e2.botName, g2 = e2.customStyles, h2 = e2.headerText, p2 = e2.customMessages, v2 = e2.placeholderText, b2 = e2.validator, S2 = e2.setMessageContainerRef, O2 = e2.disableScrollToBottom, M2 = e2.messageHistory, k2 = e2.actions, C2 = t2.messages, N2 = (0, r.useRef)(null), x2 = (0, r.useState)(""), j2 = x2[0], T2 = x2[1], A2 = function() {
          setTimeout(function() {
            var e3;
            N2.current && (N2.current.scrollTop = null === (e3 = null == N2 ? void 0 : N2.current) || void 0 === e3 ? void 0 : e3.scrollHeight);
          }, 50);
        };
        (0, r.useEffect)(function() {
          O2 || A2();
        ...
        var B2 = function() {
          n2(function(e3) {
            return E(E({}, e3), { messages: P(P([], e3.messages, true), [c(j2, "user")], false) });
          }), A2(), T2("");
        }, H2 = { backgroundColor: "" };
        g2 && g2.chatButton && (H2.backgroundColor = g2.chatButton.backgroundColor);
        var I = "Conversation with " + d2;
        h2 && (I = h2);
        var R = "Write your message here";
        return v2 && (R = v2), a().createElement("div", { className: "react-chatbot-kit-chat-container" }, a().createElement("div", { className: "react-chatbot-kit-chat-inner-container" }, a().createElement(o(), { condition: !!u2.header, show: u2.header && u2.header(m2), elseShow: a().createElement("div", { className: "react-chatbot-kit-chat-header" }, I) }), a().createElement("div", { className: "react-chatbot-kit-chat-message-container", ref: N2 }, a().createElement(o(), { condition: "string" == typeof M2 && Boolean(M2), show: a().createElement("div", { dangerouslySetInnerHTML: { __html: M2 } }) }), C2.map(function(e3, r2) {
          return "bot" === e3.type ? a().createElement(a().Fragment, { key: e3.id }, function(e4, r3) {
            ...
            if (e4.widget) {
              var l3 = s2.getWidget(i3.widget, E(E({}, t2), { scrollIntoView: A2, payload: e4.payload, actions: k2 }));
              return a().createElement(a().Fragment, null, a().createElement(y, E({ customStyles: g2.botMessageBox, withAvatar: c2 }, i3, { key: e4.id })), a().createElement(o(), { condition: !i3.loading, show: l3 || null }));
            }
            return a().createElement(y, E({ customStyles: g2.botMessageBox, key: e4.id, withAvatar: c2 }, i3, { customComponents: u2, messages: C2, setState: n2 }));
          }(e3, r2)) : "user" === e3.type ? a().createElement(a().Fragment, { key: e3.id }, function(e4) {
            var r3 = s2.getWidget(e4.widget, E(E({}, t2), { scrollIntoView: A2, payload: e4.payload, actions: k2 }));
            ...
            var r3 = p2[e4.type], o2 = { setState: n2, state: t2, scrollIntoView: A2, actionProvider: m2, payload: e4.payload, actions: k2 };
            if (e4.widget) {
              var c2 = s2.getWidget(e4.widget, E(E({}, t2), { scrollIntoView: A2, payload: e4.payload, actions: k2 }));
        ...
        } }, a().createElement("input", { className: "react-chatbot-kit-chat-input", placeholder: R, value: j2, onChange: function(e3) {
          return T2(e3.target.value);
        } }), a().createElement("button", { className: "react-chatbot-kit-chat-btn-send", style: H2 }, a().createElement(w, { className: "react-chatbot-kit-chat-btn-send-icon" }))))));
      }, O = function(e2) {
        var t2 = e2.message;
      ...
      const T = function(e2) {
        var t2 = e2.config, n2 = e2.actionProvider, o2 = e2.messageParser, s2 = e2.messageHistory, c2 = e2.runInitialMessagesWithHistory, m2 = e2.saveMessages, d2 = function(e3, t3) {
          var r2 = {};
          for (var a2 in e3)
          ...
          return r2;
        }(e2, ["config", "actionProvider", "messageParser", "messageHistory", "runInitialMessagesWithHistory", "saveMessages"]), g2 = "", f2 = "";
        if (!t2 || !n2 || !o2)
          return { configurationError: g2 = "I think you forgot to feed me some props. Did you remember to pass a config, a messageparser and an actionprovider?" };
        ...
        var p2 = (0, r.useState)({}), v2 = p2[0], y2 = p2[1], b2 = function(e3) {
        ...
        var w2, E2, P2, S2 = a().useState(x({ messages: j([], t2.initialMessages, true) }, b2)), O2 = S2[0], C2 = S2[1], T2 = a().useRef(O2.messages), A2 = a().useRef();
        (0, r.useEffect)(function() {
          T2.current = O2.messages;
        }), (0, r.useEffect)(function() {
          s2 && Array.isArray(s2) && C2(function(e3) {
          ...
          return function() {
            ...
            if (m2 && "function" == typeof m2) {
              var t3 = null === (e3 = null == v2 ? void 0 : v2.current) || void 0 === e3 ? void 0 : e3.innerHTML.toString();
              if (!v2.current)
                return;
              m2(T2.current, t3);
            }
          };
        }, [v2.current]), (0, r.useEffect)(function() {
          A2.current = O2;
        }, [O2]);
        var B2 = n2, H2 = o2;
        return k(B2) && k(H2) ? (w2 = new n2(i, C2, u, A2.current, l, d2), E2 = new N(C2, w2), P2 = new o2(w2, A2.current), M(t2).forEach(function(e3) {
          return null == E2 ? void 0 : E2.addWidget(e3, d2);
        })) : (w2 = n2, P2 = o2, E2 = new N(C2, null), M(t2).forEach(function(e3) {
          return null == E2 ? void 0 : E2.addWidget(e3, d2);
        })), { widgetRegistry: E2, actionProv: w2, messagePars: P2, configurationError: g2, invalidPropsError: f2, state: O2, setState: C2, setMessageContainerRef: y2, ActionProvider: B2, MessageParser: H2 };
      };
      var A = function() {
      ...
      const B = function(e2) {
        var t2 = e2.actionProvider, r2 = e2.messageParser, n2 = e2.config, o2 = e2.headerText, s2 = e2.placeholderText, c2 = e2.saveMessages, l2 = e2.messageHistory, u2 = e2.runInitialMessagesWithHistory, m2 = e2.disableScrollToBottom, d2 = e2.validator, g2 = function(e3, t3) {
          var r3 = {};
          for (var a2 in e3)
        ...
        return k(v2) && k(y2) ? a().createElement(S, { state: P2, setState: M2, widgetRegistry: b2, actionProvider: w2, messageParser: E2, customMessages: B2, customComponents: A({}, x2), botName: j2, customStyles: A({}, N2), headerText: o2, placeholderText: s2, setMessageContainerRef: C2, validator: d2, messageHistory: l2, disableScrollToBottom: m2 }) : a().createElement(v2, { setState: M2, createChatBotMessage: i }, a().createElement(y2, null, a().createElement(S, { state: P2, setState: M2, widgetRegistry: b2, actionProvider: v2, messageParser: y2, customMessages: B2, customComponents: A({}, x2), botName: j2, customStyles: A({}, N2), headerText: o2, placeholderText: s2, setMessageContainerRef: C2, validator: d2, messageHistory: l2, disableScrollToBottom: m2 })));
      }, H = B;
      module.exports = t;
    })();
  }
